...
export default function CoachPage({ onSendMessage, onEditProfile }) {
      ...
      <div className="hb-surface-card rounded-[2rem] p-5 sm:p-6 mb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold" style={{ color: "var(--hb-ink)" }}>
                Finance Coach
              </h1>
              <p className="text-xs" style={{ color: "var(--hb-ink-soft)" }}>
                Ask anything — I can update your data too
              </p>
            </div>
          </div>
          {onEditProfile && (
