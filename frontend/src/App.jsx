  ...
  function renderPage() {
    ...
    switch (route) {
      ...
      case "insights":
        ...
        if (!isPro) {
          return <PaywallPage onSubscribe={paywall.handleSubscribeIAP} onContinueFree={() => navigate("home")} onRestore={paywall.handleRestorePurchases} busy={paywall.paywallBusy} restoreBusy={paywall.restoreBusy} purchaseError={paywall.purchaseError} />;
        }
